...
<!-- Mirrored from yashadmin.dexignzone.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 May 2024 07:38:08 GMT -->
<head>
   <!--Title-->
	<title>Gürmar IT & Teknik Servis İş Takip Sistemi</title>
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="index.php"><img src="images/logo/logo-full.png" alt=""></a>
									</div>
                                    <h4 class="text-center mb-4">Kullanıcınıza Giriş Yapın</h4>
                                    <form action="login-rew.php" method="post">
                                        <div class="mb-3">
                                            <label class="mb-1 form-label">Kullanıcı Adı</label>
                                            <input type="text" name="username" class="form-control" placeholder="Kullanıcı Adı">
                                        </div>
                                        
                                        <div class="mb-3 position-relative">
                                            <label class="form-label" for="dz-password">Şifre</label>
                                            <input type="password" name="password" id="dz-password" class="form-control" placeholder="Şifreniz">
                                        ...
                                        <div class="form-row d-flex flex-wrap justify-content-between mb-2">
                                            ...
                                            <div class="form-group ms-2">
                                                <a class="text-hover" href="page-forgot-password.html">Şifremi Unuttum!</a>
                                            </div>
                                        </div>
